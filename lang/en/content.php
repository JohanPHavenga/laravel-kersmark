<?php
return [
    'kennisgewing_img' => 'kersmark-kennisgewing-eng.jpg',
    'menu' => [
        'home' => 'Home',
    ...
    'contact' => [
        ...
        'address' => '<strong>NG Church Bellville-Uitsig</strong><br>
    ...
    'vendor' => [
        ...
        'step1' => [
            ...
            'where' => [
                'heading' => 'Where',
                'text' => 'NG Church Bellville-Uitsig, c/o Mountainview Drive and Ridgeworth Drive, Ridgeworth, Bellville',
            ],
            'hours' => [
                'heading' => 'Business Hours',
                'text' => 'Mondays to Fridays from 10:00 to 19:00<br>Saturdays from 09:00 to 16:00.',
            ],
            'fees' => [
                'heading' => 'Fees',
                'text' => '<p>The registration fee for the selected exhibitors are:</p>
                <ul style="margin-bottom: 16px">
                <li><b>R1050</b> per full table (180cm x 75cm)</li>
                <li><b>R550</b> per half table (90cm x 75cm)</li>
                <li><b>R350</b> per 1/3 table (60cm x 75cm)</li>
            ...
            'selection' => [
                'heading' => 'Selection',
                'text' => '<p>Due to overwhelming interest, more exhibitors are applying than we can accommodate.<br>
